...
<html>
    <head>
        <title><spring:message code="label.foma.title.add.post"/></title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="topic size-div">
            <spring:message code="label.foma.title.add.post"/>
        </div>
        <form:form modelAttribute="modelPost" method="POST" action="save" accept-charset="utf-8">
            <div>
                <form:hidden path="id"/>
            </div>
            <div>
